...
if (isset($_POST["submit"])) {
  ...
  if ($result) {
    header("Location: membership.php?msg=Data updated successfully");
  } else {
...
<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #FFCCFF;">
    C'STA Members Application
  </nav>
