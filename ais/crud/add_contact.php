...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `contact`(`contact_id`, `contact_name`, `contact_studid`, `contact_email`,`contact_phone`,`contact_desc`) VALUES (NULL,'$contact_name','$contact_studid',$contact_email','$contact_phone','$contact_desc')";
...
<head>
   ...
   <title>Contact Us C'STA Application</title>
</head>

<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #CC99CC;">
     Contact Us Form for UiTMCK C'STA
   </nav>
