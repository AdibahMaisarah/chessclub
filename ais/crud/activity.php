...
<head>
  ...
  <title>UiTMCK C'STA Activities</title>
</head>

<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #CC66FF;">
    UiTMCK C'STA Activities
  </nav>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00fffff;">
<h5>| <a href="home.php">Home </a>| <a href="club.php">Club </a>| <a href="membership.php">Membership</a> | <a href="activity.php">Activities </a> | <a href="contact.php">Contact Us</a> | </h5></p>
</nav>
  <div class="container">
    <?php
    if (isset($_GET["msg"])) {
